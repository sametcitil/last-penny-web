...
export default function AdminMerchPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name || price <= 0 || stock < 0 || !category) {
      setFormError("Lütfen geçerli ad, kategori, fiyat ve stok değerleri giriniz.");
      return;
    }
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[var(--color-muted)]">Mağaza için geçerli olan kategorileri ekleyin veya silin.</p>
              </div>
